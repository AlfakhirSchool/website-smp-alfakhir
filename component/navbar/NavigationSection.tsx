...
const NavigationSection = ({ position, btnPosition, navRef }: Props) => {
  ...
  return (
    ...
    >
      <ul className={`navbar-nav ${position}`}>
        ...
        <li className="nav-item">
          ...
          <ul className="tf__droap_menu">
            ...
            <li>
              <SubNavlink href="/alfakhir-journey">
                Al-Fakhir Journey 2024
              </SubNavlink>
            </li>
            <li>
              <SubNavlink href="/buletin-alfakhir">
                Buletin Al-Fakhir 2025
              </SubNavlink>
            </li>
            <li>
        ...
        <li className="nav-item">
          ...
          <ul className="tf__droap_menu">
            <li>
              <a href="https://youtu.be/-92WZjYHiBA" target="_blank">
        ...
        {btnPosition ? null : (
          <li className="nav-item">
            <Link className="nav-link common_btn" href="/sign-up">
              Pendaftaran
            </Link>
          </li>
        )}
      ...
      {btnPosition ? (
        <Link className="common_btn_2 ms-auto" href="/sign-up">
          pendaftaran
        </Link>
      ) : null}
    </div>
